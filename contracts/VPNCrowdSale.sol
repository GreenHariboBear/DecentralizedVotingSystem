...
contract SimpleToken is StandardToken {
  ...
  string public constant name = "Virtual Packaging Network"; // solium-disable-line uppercase
  string public constant symbol = "VPN"; // solium-disable-line uppercase
...
contract Crowdsale is Ownable{
 ...
 /**
   ...
   * @return Number of tokens that can be purchased with the specified _weiAmount (price)
   */
...
contract MyCrowdsale is CappedCrowdsale, RefundableCrowdsale{
